document.addEventListener("DOMContentLoaded", () => {
  ...
  function AddToAPI() {
    let item = CreateItem(inputCourse.value,inputDuration.value,inputSubject.value,inputTopics.value);
    if (item.thing.course === "" || item.thing.duration === "" || item.thing.subject === "" || item.thing.topics === ""){
